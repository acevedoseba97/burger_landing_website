...
const Footer = () => {
  return (
    <div className="pt-[5rem] pb-[3rem] bg-gray-900">
      <div className="w-[80%] pb-[2rem] border-b-[2px] border-gray-300 border-opacity-50 mx-auto grid  grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-[3rem] items-start">
        {/* 1st part */}
        <div>
          {/* Logo */}
          ...
          <p className="text-red-300 text-[19px] font-bold">+(123) 2346 8737</p>
        </div>

        {/* 2nd part */}
        <div>
          <h2 className="text-[23px] font-semibold mb-[2rem] text-white">
            Products
          </h2>
        ...
        {/* 4th part */}
        <div>
          <h2 className="text-[23px] font-semibold mb-[2rem] text-white uppercase">
            Opening Hours
          </h2>
          ...
          <div className="flex mt-[2rem] items-center space-x-6">
            ...
            <FaXTwitter className="w-[1.5rem] h-[1.5rem] text-gray-300" />
          </div>
        </div>
      </div>
      ...
      <p className="text-center text-white opacity-50 mt-[1.5rem]">
        Copyright © 2024 <span className="text-yellow-200">BurgerBite</span>.
        All rights reserved
      </p>
    </div>
  );
