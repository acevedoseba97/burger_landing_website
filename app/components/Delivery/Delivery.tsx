      ...
      <div className="w-[80%] mx-auto grid items-center grid-cols-1 lg:grid-cols-2 gap-[3rem]">
        ...
        <div>
          ...
          <p className="mt-[2rem] text-black text-[17px] text-opacity-70">
            ...
            iusto illo cupiditate ea, a nostrum aspernatur culpa deleniti
            soluta, similique assumenda dolor nulla dolores. Accusamus expedita
            architecto consequatur vel!
          </p>
